...
// The passcode lock screen (used when Google sign-in isn't set up). One field,
// friendly copy. On success the server sets the session cookie and we send you
// to your HQ. /login is EXCLUDED from the gate in proxy.ts.
