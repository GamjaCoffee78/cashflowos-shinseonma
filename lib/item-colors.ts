...
export const ITEM_COLORS = [
  { key: 'red',    label: 'Red',    fg: '#C2302A', bg: 'rgba(194,48,42,.24)' },
  { key: 'orange', label: 'Orange', fg: '#D9731A', bg: 'rgba(217,115,26,.24)' },
  { key: 'yellow', label: 'Yellow', fg: '#B8940F', bg: 'rgba(230,190,40,.30)' },
  { key: 'green',  label: 'Green',  fg: '#2E8B57', bg: 'rgba(46,139,87,.24)' },
  { key: 'teal',   label: 'Teal',   fg: '#16877F', bg: 'rgba(22,135,127,.24)' },
  { key: 'blue',   label: 'Blue',   fg: '#1E5FC4', bg: 'rgba(30,95,196,.24)' },
  { key: 'purple', label: 'Purple', fg: '#7A4FB5', bg: 'rgba(122,79,181,.24)' },
  { key: 'pink',   label: 'Pink',   fg: '#C8407E', bg: 'rgba(200,64,126,.24)' },
] as const
