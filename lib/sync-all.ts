...
const STEPS: Source[] = [
  ...
  { key: 'production_sheet', label: 'Work sheet (production · social · events)', configured: productionSheetConfigured(), missing: 'productionSheet.composioAccount (abang/config.ts)', run: () => syncProductionFromSheet() },
